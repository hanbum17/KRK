...
<div class="panel-heading">
    <h4 style="display:inline-block;white-space: nowrap;" ><c:out value="${myBoard.bno}"/>번 게시글 상세</h4>
...
<div class="panel-body form-horizontal">
    ...
    <div class="form-group">
        <label class="col-sm-2 control-label" style="white-space: nowrap;">작성자</label>
        <input class="form-control" name="bwriter"
               value='<c:out value="${myBoard.bwriter}"/>' readonly="readonly"/>
    </div>
    <div class="form-group">
        <label class="col-sm-2 control-label" style="white-space: nowrap;">최종수정일</label> [등록일시: <fmt:formatDate pattern="yyyy/MM/dd HH:mm:ss" value="${myBoard.bregDate}"/>]
...
var loginUser = '';
//isAuthenticated() 는 로그인하면 true를 반환
<security:authorize access="isAuthenticated()">
