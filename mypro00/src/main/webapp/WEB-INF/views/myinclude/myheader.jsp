...
<head>
	...
	<!-- favicon을 사용하지 않도록 설정 --><!-- 
	<link rel="shortcut icon" href="data:image/x-icon;," type="image/x-icon"> --> <%-- 
	<link rel="shortcut icon" href="${contextPath }/resources/icons/favicon.ico" type="image/x-icon"> --%><%-- 
	<link rel="shortcut icon" href="${contextPath }/resources/icons/favicon.svg" type="image/svg+xml"> --%><%-- 
	<link rel="shortcut icon" href="${contextPath }/resources/icons/favicon.png" type="image/png"> --%>
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="/mypro00/">
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="/mypro00/myboard/list"><i class="fa fa-dashboard fa-fw"></i> 게시물 목록 이동</a>
                        </li>
                        <li>
                            <a href="/mypro00/myboard/register"><i class="fa fa-bar-chart-o fa-fw"></i> 게시물 등록<span class="fa arrow"></span></a>
                        </li>
                        <li>
                            <a href="/mypro00/myboard/detail?bno=229742&pageNum=1"><i class="fa fa-table fa-fw"></i> 게시물 상세 이동</a>
                        </li>
                        <li>
                            <a href="/mypro00/login"><i class="fa fa-edit fa-fw"></i> 로그인</a>
                        </li>
                        <li>
                            <a href="/mypro00/logout"><i class="fa fa-wrench fa-fw"></i> 로그아웃<span class="fa arrow"></span></a>
                        </li>
                        <li>
