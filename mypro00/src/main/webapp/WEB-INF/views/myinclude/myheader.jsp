    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="/mypro00/">My Admin Board - Home</a>
            </div>
            <!-- /.navbar-header -->
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="/mypro00/myboard/list"><i class="fa fa-dashboard fa-fw"></i> Board-List</a>
                        </li>
                        <li>
                            <a href="/mypro00/myboard/register"><i class="fa fa-bar-chart-o fa-fw"></i> Board-Registar</a>
                            
                            <!-- /.nav-second-level -->
                        </li>
                        <li>
                            <a href="/mypro00/myboard/detail?bno=229804&pageNum=1"><i class="fa fa-table fa-fw"></i> Board-Detail</a>
                        </li>
                        <li>
                            <a href="/mypro00/login"><i class="fa fa-edit fa-fw"></i> Login</a>
                        </li>
                        <li>
                            <a href="/mypro00/logout"><i class="fa fa-wrench fa-fw"></i> Logout</a>
