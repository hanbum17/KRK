...
public class Test04MyReplyServiceTests {
...
//                myReplyService.getReplyList(new MyReplyPagingDTO(229402L, 2));
...
//    	
//    	MyReplyVO myReply = new MyReplyVO();
//        myReply.setBno(229402);
//        myReply.setRcontent("서비스 테스트 - 게시물의 댓글에 대한 답글 등록 테스트");
//        myReply.setRwriter("test");
//        myReply.setPrno(43L);  //앞에서 등록한 댓글번호
//
...
//        log.info(myReplyService.getMyReply(229402L, 1));
//    }
