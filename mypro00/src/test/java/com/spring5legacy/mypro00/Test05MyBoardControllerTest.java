...
//                               .get("/myboard/modify")  // /myboard/modify로 수정한 후, 다시 테스트
//                               .param("bno", "1")
//                               //.param("from", "m")  //수정 후, detail.jsp 호출: bviewsCnt 증가 않되어야 함
//                               )
//                        .andReturn()
//                        .getModelAndView()
//                        .getModelMap());
...
//                                              .post("/myboard/modify")
//                                              .param("bno", "1")
//                                              .param("btitle", "게시물 수정-컨트롤러 테스트 제목3333")   //2222추가 테스트
//                                              .param("bcontent", "게시물 수정-컨트롤러 테스트 내용3333")
//                                              .param("bwriter", "test"))
//                                      .andReturn()
//                                      .getModelAndView()
//                                      .getViewName();
