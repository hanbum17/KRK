            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="/mypro00/myboard/list"><i class="fa fa-dashboard fa-fw"></i> 게시물목록</a>
                        </li>
                        <li>
                            <a href="/mypro00/myboard/register"><i class="fa fa-bar-chart-o fa-fw"></i> 게시물 등록</a>
                        </li>
                        <li>
                            <a href="/mypro00/myboard/detail?bno=30000&pageNum=1"><i class="fa fa-table fa-fw"></i> 게시물 상세 이동</a>
                        </li>
                        <li>
                            <a href="/mypro00/login"><i class="fa fa-edit fa-fw"></i> 로그인</a>
                        </li>
                        <li>
                            <a href="/mypro00/logout"><i class="fa fa-wrench fa-fw"></i> 로그아웃</a>
