...
//	}
	...
	public void testSelectMyBoard() {
		System.out.println(myBoardMapper.selectMyBoard (30781L));
	}
...
//		myBoard.setBtitle("매퍼 테스트-입력 제목noKey");
//		myBoard.setBcontent("매퍼 테스트-입력 내용noKey");
...
//		myBoardMapper.updateBdelFlag(9L);
